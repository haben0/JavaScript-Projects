...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            //If active is "X" change it to "O".
            activePlayer = "O";
        //If active playe is anthing other than "X"
        } else {
        ...
        //This conditon check to see if it is computers turn.
        if (activePlayer === "O") {
...
//This function prase the selectedSquares array to search for win conditions.
...
function audio(audioURL) {
    ...
    //Playe method plays our audio sound.
    audio.play();
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This line indicates where the start of the a lines y axis is.
        y1 = coordY1,
        //This line indicates where the end of a line x axis is.
        x2 = coordX2,
        //This line indicates where the end of a line y axix is.
        y2 = coordY2,
        //This variable stores temporary x axis dat we update in our animation loop.
        x = x1,
        //This variable stores temporary y axis dat we update in our animation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        //It was necessary for the 6, 4, 2 win conditon.
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
            if (x >= x2 && y <= y2) { cancelAnimationFrame (animationLoop); }
    ...
    setTimeout(function () { clear(); restartGame();}, 1000);
}
...
function restartGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //This removes our elemets backgroundImage.
