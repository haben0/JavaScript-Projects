...
const Calculator = {
    ...
    First_Operand: null,
    // this checks whether or not the secon operand has been input
...
function Input_Digit(digit) {
    ...
    // this overwrites Display if the current value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    // Calculator.First_Operand if it doen't already exist
    ...
    if (First_Operand == null) {
        ...
        //in the Perform_Calculation object and the function that maches the
